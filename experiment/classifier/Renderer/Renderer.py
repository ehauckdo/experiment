...
def render(map,simulation = None, path = None):
    ...
    canvas.bind("<Double-Button-3>",savefile)
...
def osmToImage(fileName = "rendered"):
    # save postscipt image
    #print("saving file")
    canvas.postscript(file = fileName + '.eps',height = scale *canvasSize[1], width = scale *canvasSize[0])
